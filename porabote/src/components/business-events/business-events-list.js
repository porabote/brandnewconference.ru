                    ...
                    <FeedListBody {...this.props}>
                        {this.props.storage.map((data) => {
                            return <FeedListBodyRow
                                ...
                                linkTo={`/business-events/view/${data.id}`}
                            />
                        })}
                    </FeedListBody>
                </FeedList>
...
const mapStateToProps = store => ({...store.business-events})
...
export default connect(mapStateToProps, mapDispatchToProps)(ListWithData(BusinessEventsList, 'business-events'))