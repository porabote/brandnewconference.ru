...
class SparesViewFiles extends Component {
    ...
    render() {
        ...
        return(
            <div>
                ...
                <ButtonUpload
                    progressBar={false}
                    uri='/api/spares/method/uploadReportFile/'
                    previewPanel={() => {
                        return(
                            <div>
                                <Field>
                                ...
                                <Field>
                                    <InputHidden name="model_alias" defaultValue="spares" />
                                </Field>
                            </div>
                        )
                    }}
...
export default SparesViewFiles