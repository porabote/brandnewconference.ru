...
import { fetchRecordsThunk } from './spares-actions'
...
const mapStateToProps = store => ({...store.spares})
...
export default connect(mapStateToProps, mapDispatchToProps)(ListWithData(SparesList, 'spares'))