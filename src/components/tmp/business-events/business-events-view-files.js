...
class BusinessEventsViewFiles extends Component {
    ...
    render() {
        ...
        return(
            <div>
                ...
                <ButtonUpload
                    progressBar={false}
                    uri='/api/business-events/method/uploadReportFile/'
                    previewPanel={() => {
                        return(
                            <div>
                                <Field>
                                ...
                                <Field>
                                    <InputHidden name="model_alias" defaultValue="business-events" />
                                </Field>
                            </div>
                        )
                    }}
...
export default BusinessEventsViewFiles