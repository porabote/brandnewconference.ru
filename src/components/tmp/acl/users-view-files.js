...
class UsersViewFiles extends Component {
    ...
    render() {
        ...
        return(
            <div>
                ...
                <ButtonUpload
                    progressBar={false}
                    uri='/api/users/method/uploadReportFile/'
                    previewPanel={() => {
                        return(
                            <div>
                                <Field>
                                ...
                                <Field>
                                    <InputHidden name="model_alias" defaultValue="users" />
                                </Field>
                            </div>
                        )
                    }}
