    ...
    return (
        <div>
            ...
            <p>Спасибо за интерес к нашей конференции! Вашу заявку на офлайн-участие рассмотрим в течение недели.
                Модерация нужна, чтобы мы поместились на площадке и гостям было комфортно. Ещё один фактор,
                который мы учитываем — эпидемиологическая обстановка. За неделю до события или раньше пришлëм письмо с
            ...
            <div id="registration" className="main-page__registration">
                ...
                <div className="main-page__registration__grid-container">
                    ...
                    <div className="main-page__registration__descr">
                        <p>
                            Онлайн-трансляция доступна для всех желающих. В офлайне места ограничены, их итоговое количество также будет зависеть и от эпидемиологической обстановки. Все заявки проходят модерацию, ответ придет вам на почту за неделю до события или раньше.
                        </p>
                        <p>
                            Регистрацию на офлайн закрываем 12 сентября в 10:00.
                        </p>
                    </div>
